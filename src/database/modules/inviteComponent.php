<?php
	...
	require_once __DIR__ . '/userComponent.php';
	...
	class InviteComponent {
		...
		public function __construct($_project) {
			...
			$this->userComponent = new userComponent($this->Project);
		}
		...
		public function inviteByEmail($_emailAdress) {
			...
			return $this->userComponent->update($user);
		}	
		...
		private function sendMail($_emailAdress, $_inviteId) {
			$senderName = $this->Project->curUser->name;
		...
		private function checkIfEmailAdressAlreadyExists($_emailAdress) {
			$users = $this->userComponent->getAll();
